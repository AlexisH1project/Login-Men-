...
<body>
 ...
 <div class="banner-img">
           <img src="resource/images/ss1.png" width="25%" height="25%" alt="Logo-UAM-C" vertical-align="center"/>
        </div>
        <br/>
        <br/>
        <br/>
                    ...
                    <div class="form">
                        <h:form class="login-form">
                             <div class="container">
                                ...
                                <button type="button" class="btn btn-danger" id="singin" type="button">ingresar</button>
                                </div>
                              </div>
